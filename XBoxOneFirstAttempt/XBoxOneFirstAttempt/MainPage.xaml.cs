...
namespace XBoxOneFirstAttempt
{
	...
	public sealed partial class MainPage : Page
	{
        ...
        private void SpawnTop()
        {
                ...
                rectangle.Margin = new Thickness(40, 40, 0, 0);
                rectangle.Height = 5;
                rectangle.Width = 880;
		...
		private void DispatcherTimer_Tick( object sender, object e )
		{
            ...
            //Ball.Margin.Top >= brick.Margin.Top + brick.Height
            //            && Ball.Margin.Top - ballSpeed <= brick.Margin.Top + brick.Height
            //            && Ball.Margin.Left >= brick.Margin.Left
            //            && Ball.Margin.Left + Ball.Width <= brick.Margin.Left + brick.Width

            if (Ball.Margin.Top >= TopWall.Margin.Left + TopWall.Height 
                && Ball.Margin.Top - ballSpeed <= TopWall.Margin.Left + TopWall.Height)
            {
                downward = true;
            }
        ...
        private void SpawnBlocks()
        {
            int count = 1;
             ...
             while (count < 23)
             {
                    ...
                    rectangle.Fill = GetRandomColor();
                    rectangle.Stroke = new SolidColorBrush(Color.FromArgb(255, 255, 255, 255));
                    rectangle.Margin = new Thickness(count * 40, 100, 0, 0);
                    rectangle.Height = 20;
                    rectangle.Width = 40;
                    rectangle.HorizontalAlignment = HorizontalAlignment.Left;
                    rectangle.VerticalAlignment = VerticalAlignment.Top;
            ...
            while (count < 23)
            {
                ...
                rectangle.Fill = GetRandomColor();
                rectangle.Stroke = new SolidColorBrush(Color.FromArgb(255, 255, 255, 255));
                rectangle.Margin = new Thickness(count * 40, 120, 0, 0);
                rectangle.Height = 20;
                rectangle.Width = 40;
                rectangle.HorizontalAlignment = HorizontalAlignment.Left;
                rectangle.VerticalAlignment = VerticalAlignment.Top;
            ...
            while (count < 23)
            {
                ...
                rectangle.Fill = GetRandomColor();
                rectangle.Stroke = new SolidColorBrush(Color.FromArgb(255, 255, 255, 255));
                rectangle.Margin = new Thickness(count * 40, 140, 0, 0);
                rectangle.Height = 20;
                rectangle.Width = 40;
                rectangle.HorizontalAlignment = HorizontalAlignment.Left;
                rectangle.VerticalAlignment = VerticalAlignment.Top;
